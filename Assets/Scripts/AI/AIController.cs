...
public class AIController : NetworkBehaviour
{
    ...
    void PatrolEnter() 
    {
        patrolTarget = new Vector3(
            UnityEngine.Random.Range(movementSampleConstraints.x, movementSampleConstraints.y),
            0.0f,
            UnityEngine.Random.Range(movementSampleConstraints.z, movementSampleConstraints.w)
        );
    ...
    {
        Debug.Log("Stop resetting this variable, Jerry.");
